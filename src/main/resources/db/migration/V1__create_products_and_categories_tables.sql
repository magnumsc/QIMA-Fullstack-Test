...
CREATE SCHEMA IF NOT EXISTS "qima_interview";

CREATE TABLE "qima_interview"."categories" (
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    parent INTEGER,
    CONSTRAINT fk_parent FOREIGN KEY(parent) REFERENCES "qima_interview"."categories"(id)
);

CREATE TABLE "qima_interview"."products" (
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    description TEXT,
    ...
    CONSTRAINT fk_category FOREIGN KEY(category) REFERENCES "qima_interview"."categories"(id)
);

insert into "qima_interview"."categories" (name, parent) values
('Electronics', null),
('Computers', 1),
('Laptops', 2),
('Desktops', 2),
...
insert into "qima_interview"."products" (name, description, price, category, available, image_url, stock) values
